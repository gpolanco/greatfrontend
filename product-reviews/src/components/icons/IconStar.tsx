...
export const IconStar: FC<IIconStarProps> = ({ type = "empty" }) => {
  if (type === "full") {
    return (
      <svg
        aria-label="rating-full-star"
        className="w-5 h-5"
        fill="none"
